...
trait SearchableTrait
{
    ...
    public function scopeSearchRestricted(Builder $q, $search, $restriction, $threshold = null, $entireText = false, $entireTextOnly = false): Builder
    {
        $query = clone $q;
        ...
        $words = $matches[1];
        for ($i = 2, $iMax = count($matches); $i < $iMax; $i++) {
     ...
     * @return string
     */
    protected function getSearchQuery(string $column, string $relevance, array $words, float $relevance_multiplier, string $pre_word = '', string $post_word = ''): string
    {
     ...
     * @return string
     */
    protected function getCaseCompare($column, $compare, $relevance): string
    {
     ...
     */
    protected function filterQueryWithRelevance(Builder $query, array $selects, $relevance_count): void
    {
     ...
     * @return array
     */
    protected function getGroupBy(): bool|array
    {
